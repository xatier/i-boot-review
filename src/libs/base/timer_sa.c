...
// Description:
//
//      Interfaces with the StrongArm SA1110 RTC.
//
// Author:
//
//      Mike Kirkland
...
////////////////////////////////////////////////////////////////////////////////
// init_timer
// PURPOSE: Brings the StrongARM RTC up to a stable state.
// PARAMS:  None.
// RETURNS: Nothing.
// NOTES:   Will take between 2-10 seconds after a reset to complete.
////////////////////////////////////////////////////////////////////////////////
void
init_timer(void)
{
   //wait for the RTC to stabilize (takes 2-10 seconds)
   while(!POSR)
   {
      ; //do nothing
   }
